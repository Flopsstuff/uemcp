...
import { extractOptionalString, extractString, normalizeArgs, resolveObjectPath } from './argument-helper.js';
...
import type { ComponentInfo } from '../../types/handler-types.js';
